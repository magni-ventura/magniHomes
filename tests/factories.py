...
class ProfileFactory(factory.django.DjangoModelFactory):
    ...
    phone_number = factory.LazyAttribute(lambda x: x.phone_number())
...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    username = factory.LazyAttribute(lambda x: x.username())
    email = factory.LazyAttribute(lambda x: faker.email())
    password = factory.LazyAttribute(lambda x: x.password())
    is_active =True
    is_staff = True
