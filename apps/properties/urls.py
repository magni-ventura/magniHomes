...
urlpatterns = [
    ...
    path("update-property/<slug:slug>/", views.update_property_api_view, name="update-property"),
    
    path("delete-property/<slug:slug>/", views.delete_property_api_view, name="delete-property"),
