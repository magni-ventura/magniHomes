    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_code', models.CharField(blank=True, max_length=255, unique=True, verbose_name='Property Ref Code')),
                ...
                ('city', models.CharField(blank=True, default='Abuja', max_length=180, verbose_name='City')),
                ('postal_code', models.CharField(default='150', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='Unity Avenue', max_length=150, verbose_name='Street Address')),
                ('property_number', models.IntegerField(default=120, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Property Number')),
                ...
                ('property_type', models.CharField(choices=[('House', 'House'), ('Flat', 'Flat'), ('Duplex', 'Duplex'), ('Condo', 'Condo'), ('Air_BNB', 'Air_BNB'), ('Bungalow', 'Bungalow'), ('Apartment', 'Apartment'), ('Office', 'Office'), ('Warehouse', 'Warehouse'), ('Commercial', 'Commercial'), ('Other', 'Other')], default='Other', max_length=50, verbose_name='Property type')),
